  ...
  return (
    <>
      ...
      <Box sx={{ backgroundColor: 'white', mt: 5, height: 250, width: 600, padding: 6 }}>
        <Typography className='fs-5 fw-bold text-center' style={{ fontFamily: 'poppins' }}>Add Department</Typography>
        ...
        <Button style={{backgroundColor:'#1890ff',width:320,marginTop:25,marginLeft:112,textAlign:'center',color:'white',fontFamily:'poppins'}}>Add New Department</Button>
      </Box>
